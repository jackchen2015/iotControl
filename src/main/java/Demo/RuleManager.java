...
public class RuleManager extends ManagerModule {
	...
	void addCreateAndUpdateRuleItem(JPanel pCurPanel) {
		...
		final JPanel pCreateAndUpdateRule = new JPanel();
		pCreateAndUpdateRule.setLayout(new FlowLayout());
	...
	void addQueryRuleItem(JPanel pCurPanel) {
		...
		final JTextField tfAuthor = new JTextField(MainWin.TEXT_FIELD_SHORT);
		pQueryRule.add(tfAuthor);
		// Rule Name
		pQueryRule.add(new JLabel("Name(O):"));
		final JTextField tfName = new JTextField(MainWin.TEXT_FIELD_LONG);
	...
	void addModifyRuleItem(JPanel pCurPanel) {
		...
		final JTextField tfRuleID = new JTextField(MainWin.TEXT_FIELD_LONG);
		pModifyRule.add(tfRuleID);
		// Status
		final JComboBox<String> boxStatus = new JComboBox<String>();
	...
	void updateCreateAndUpdateRuleItem(final JPanel pCreateAndUpdate, String strDeviceId, final Vector<ServiceInfo> vServiceList) {
		// Check Param
		...
		final JTextField tfRuleName = new JTextField(MainWin.TEXT_FIELD_LONG);
		...
		final JComboBox<String> boxProperty = new JComboBox<String>();
		for (int i = 0; i < vServiceList.size(); ++i) {
		...
		// Operation
		final JComboBox<String> boxOperation = new JComboBox<String>();
		...
		final JComboBox<String> boxAction = new JComboBox<String>();
		boxAction.addItem("SMS");
		boxAction.addItem("EMAIL");
		pLayerB.add(boxAction);
		// Address
		pLayerB.add(new JLabel("Address:"));
		final JTextField tfAddress = new JTextField(MainWin.TEXT_FIELD_SHORT);
		pLayerB.add(tfAddress);
		// Tilte
		pLayerB.add(new JLabel("Title:"));
		final JTextField tfTitle = new JTextField(MainWin.TEXT_FIELD_LONG);
		pLayerB.add(tfTitle);
		// Content
		pLayerB.add(new JLabel("Content:"));
		final JTextField tfContent = new JTextField(MainWin.TEXT_FIELD_LONG);
