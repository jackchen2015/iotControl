...
public class CommandManager extends ManagerModule {
	...
	void addPostAsyncCmdItem(JPanel pCurPanel) {
		// Post Async Command
		final JPanel pPostAsyncCmd = new JPanel();
		pPostAsyncCmd.setLayout(new FlowLayout());
	...
	void updatePostAsyncCmdItemWithRawData(final JPanel pPostAsyncCmd, String strDeviceId) {
		// Update Main Frame
		...
		final JTextField tfData = new JTextField(MainWin.TEXT_FIELD_LONG);
		pPostAsyncCmd.add(tfData);
		// Expire Time
		pPostAsyncCmd.add(new JLabel("Expire Time:"));
		final JTextField tfExpireTime = new JTextField(MainWin.TEXT_FIELD_SHORT);
	...
	void updatePostAsyncCmdItemNormal(final JPanel pPostAsyncCmd, String strDeviceId, final Vector<ServiceInfo> vServiceList) {
		// Update Main Frame
		mManager.setVisible(false);
		pPostAsyncCmd.removeAll();
		...
		// Device ID
		pPostAsyncCmd.add(new JLabel("Device ID:"));
		final JTextField tfDeviceId = new JTextField(MainWin.TEXT_FIELD_SHORT);
		pPostAsyncCmd.add(tfDeviceId);
		tfDeviceId.setText(strDeviceId);
		// Service Id Box
		pPostAsyncCmd.add(new JLabel("Service:"));
		...
		final JComboBox<String> boxCommand = new JComboBox<String>();
		...
		// Item Box
		final JComboBox<String> boxItem = new JComboBox<String>();
