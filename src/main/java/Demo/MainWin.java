...
public class MainWin extends JPanel {
	...
	public boolean init() {
		...
		final JComboBox<String> boxSolution = new JComboBox<String>(SOLUTION_LIST);
		pModuleChoose.add(boxSolution);
		pModuleChoose.add(new JLabel("Module:"));
		final JComboBox<String> boxModule = new JComboBox<String>(MODULE_LIST);
		pModuleChoose.add(boxModule);

		// Manager Panel
		final JPanel pManager = new JPanel();
		addComp(pManager);
